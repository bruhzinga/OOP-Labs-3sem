...
namespace LABA10
{
    public class Book : IDictionary
    {
        ...
        // Construct the Book with the desired number of items.
        // The number of items cannot change for the life time of this Book.
        public Book(int numItems)
        {
        ...
        private class BookEnumerator : IDictionaryEnumerator
        {
            // A copy of the Book object's key/value pairs.
            private DictionaryEntry[] items;

            private int index = -1;

            public BookEnumerator(Book sd)
            {
                // Make a copy of the dictionary entries currently in the Book object.
